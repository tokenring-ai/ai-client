...
function mangleRequest(request) {
 ...
 const systemMessages = combinedMessages.filter(msg => msg.role === 'system');
 const nonSystemMessages = combinedMessages.filter(msg => msg.role !== 'system');
